...
#Return the number of true positive, true negative, false positive and false negative
...
try:
	...
	print('usage: python3 accuracy.py --load_weights=<weightPath> --dataDir=<npyDataDirectory> --tol=<toleranceValue>')
	exit(1)
